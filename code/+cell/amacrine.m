...
for mm = 1:length(cardinalMeridianAngles)
    ...
    amacrine.density.fitMMSq.(cardinalMeridianNames{mm}) = ...
        fit(amacrine.density.supportMM.(cardinalMeridianNames{mm})', amacrine.density.countsMMSq.(cardinalMeridianNames{mm})', 'smoothingspline');
end
