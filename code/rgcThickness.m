...
%% RGC and IPL thickness measurements as reported by Curcio 2011
% determined by 18 histologically sectioned maculas.
...
%
% Data from Curcio 2011, Figure 7B and 7C
...
empiricalThickness.RGC.thickMM.temporal = [.00455, .00455, .01212, .02273, .03485, .04848, .05303, .05758, .06061, .05909, .05606, .05303, .05, .04545, .03636, .03485, .0303, .02727, .02121, .02121];
